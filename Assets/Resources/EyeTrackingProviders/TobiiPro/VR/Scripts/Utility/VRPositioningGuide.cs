...
namespace Tobii.Research.Unity
{
    ...
    public class VRPositioningGuide : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                {
                 Debug.Log("Positioning Key Pressed ");
                }
            ...
            if (HMDPlacementCanvas != null)
            {
                ...
                if (Time.frameCount % 2 == 0) // it was 45%
                {
                ...
                _leftPupilXY = data.Left.PupilPositionInTrackingArea ? data.Left.PupilPosiitionInTrackingArea : _leftPupilXY;
                _rightPupilXY = data.Right.PupilPositionInTrackingArea ? data.Right.PupilPosiitionInTrackingArea : _rightPupilXY;
                ...
                _leftImage.color = data.Left.PupilPositionInTrackingArea ? Color.Lerp(Color.green, Color.red, leftDistance / 0.35f) : Color.clear;
                _rightImage.color = data.Right.PupilPositionInTrackingArea ? Color.Lerp(Color.green, Color.red, rightDistance / 0.14f) : Color.clear;
                //Debug.Log("Update time Eye:" + Time.deltaTime);
                //Debug.Log("UPDATE: Frame count Eye = " + Time.frameCount + "\nRendered frame count Eye = " + Time.renderedFrameCount);
