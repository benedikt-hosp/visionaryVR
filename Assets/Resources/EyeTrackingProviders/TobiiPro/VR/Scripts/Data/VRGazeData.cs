...
namespace Tobii.Research.Unity
{
    public sealed class VRGazeData : IVRGazeData
    {
        ...
        //public long TimeStamp2 { get; private set; }
    ...
    public sealed class VRGazeDataEye : IVRGazeDataEye
    {
        ...
        public bool PupilPositionInTrackingArea { get; private set; }
        ...
        internal VRGazeDataEye(HMDEyeData eye, Transform eyeTrackerOrigin)
        {
            ...
            PupilPositionInTrackingArea = eye.PupilPosition.Validity.Valid();
        }
        ...
        internal VRGazeDataEye()
        {
            ...
            PupilPositionInTrackingArea = false;
        }
    }
